...
struct Static
{
	 ...
	 */
	Static(const Vector2d<T>& position)
	 ...
	 */
	Static(const Vector2d<T>& position, double orientation)
	 ...
	 */
	void setOrientationFromVelocity(const Vector2d<T>& velocity);

	/**
	 * Returns a unit vector in the direction of the current
	 * orientation.
	 */
	Vector2d<T> getOrientationAsVector() const;
