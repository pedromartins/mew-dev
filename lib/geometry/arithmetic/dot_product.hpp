...
namespace geometry
{
	namespace impl
	{
		...
		struct dot_product_maker
		{
			...
			static typename support::coordinate<P1>::type
	...
	(typename support::coordinate<P1>::type)) dot_product(const P1& p1, const P2& p2)
	{
		return impl::dot_product_maker<0, support::dimension<P1>::value - 1>::run(p1, p2);
	}
