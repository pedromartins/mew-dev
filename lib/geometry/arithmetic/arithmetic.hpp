...
namespace geometry
{
	...
	{ for_each_coordinate(p, impl::value_operation<typename support::coordinate<P>::type, std::plus>(value)); }
	...
	{ for_each_coordinate(p, impl::value_operation<typename support::coordinate<P>::type, std::minus>(value)); }
	...
	{ for_each_coordinate(p, impl::value_operation<typename support::coordinate<P>::type, std::multiplies>(value)); }
	...
	{ for_each_coordinate(p, impl::value_operation<typename support::coordinate<P>::type, std::divides>(value)); }
