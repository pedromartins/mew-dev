...
void test_all()
{
	...
	geometry::point_ll<geometry::radian, T> p2;
	geometry::convert_dr(p1, p2);
...
{
	test_all<geometry::point_ll<geometry::degree, float> >();
	test_all<geometry::point_ll<geometry::degree, double> >();
